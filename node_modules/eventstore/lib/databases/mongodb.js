...
_.extend(Mongo.prototype, {
      ...
      this.db.open(function (err, client) {
       ...
       if (err) {
        ...
        self.events = self.db.collection(options.eventsCollectionName);
          console.log("events array created" +self.events);
  ...
  getEvents: function (query, skip, limit, callback) {
    ...
    if(this.events) {
          if (limit === -1) {
              return this.events.find(findStatement, { sort: [
                  ['commitStamp', 'asc'],
                  ['streamRevision', 'asc'],
                  ['commitSequence', 'asc']
              ] }).skip(skip).toArray(callback);
          }
          console.log("events" + this.events);
          this.events.find(findStatement,
              { sort: [
                  ['commitStamp', 'asc'],
                  ['streamRevision', 'asc'],
                  ['commitSequence', 'asc']
          ...
          console.log("events not defined");
      }
  },
